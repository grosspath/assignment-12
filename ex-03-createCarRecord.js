...
var createCarRecord = function (carMake, carModel, carYear, carLicense) {

  if(!carMake || !carModel || !carYear|| !carLicense)

    return "new record must have make, model, year, and license values";

  if (typeof carMake !== "string" || typeof carModel !== "string" || typeof carLicense !== "string")
